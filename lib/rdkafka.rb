...
require "rdkafka/admin/alter_config_handle"
require "rdkafka/admin/alter_config_report"
...
require "rdkafka/admin/describe_config_handle"
require "rdkafka/admin/describe_config_report"
